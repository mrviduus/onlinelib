...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260419174808_SetNullOnOwnerDelete")]
    partial class SetNullOnOwnerDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.BoardTask", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_board_tasks");

                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_board_tasks_site_id");

                    b.HasIndex("SiteId", "Status")
                        .HasDatabaseName("ix_board_tasks_site_id_status");
            ...
            modelBuilder.Entity("Domain.Entities.CodeGenJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("CompletedIterations")
                        .HasColumnType("integer")
                        .HasColumnName("completed_iterations");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_code_gen_jobs");

                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_code_gen_jobs_site_id");

                    b.ToTable("code_gen_jobs", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ReadingRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reading_rooms");

                    b.HasIndex("LastActivityAt")
                        .HasDatabaseName("ix_reading_rooms_last_activity_at");

                    b.HasIndex("OwnerUserId")
                        .HasDatabaseName("ix_reading_rooms_owner_user_id");

                    b.HasIndex("SiteId")
                        .HasDatabaseName("ix_reading_rooms_site_id");

                    b.HasIndex("TargetType", "TargetId")
                        .HasDatabaseName("ix_reading_rooms_target_type_target_id");

                    b.ToTable("reading_rooms", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.ReadingRoomInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reading_room_invites");

                    b.HasIndex("CreatedByUserId")
                        .HasDatabaseName("ix_reading_room_invites_created_by_user_id");

                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_reading_room_invites_room_id");

                    b.HasIndex("TokenHash")
                        .IsUnique()
                        .HasDatabaseName("ix_reading_room_invites_token_hash");

                    b.ToTable("reading_room_invites", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.ReadingRoomMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("CurrentChapterId")
                        .HasColumnType("uuid")
                        .HasColumnName("current_chapter_id");

                    b.Property<double?>("CurrentPercent")
                        .HasColumnType("double precision")
                        .HasColumnName("current_percent");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_reading_room_members");

                    b.HasIndex("CurrentChapterId")
                        .HasDatabaseName("ix_reading_room_members_current_chapter_id");

                    b.HasIndex("RoomId")
                        .HasDatabaseName("ix_reading_room_members_room_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_reading_room_members_user_id");

                    b.HasIndex("RoomId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_reading_room_members_room_id_user_id")
                        .HasFilter("left_at IS NULL");

                    b.ToTable("reading_room_members", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.VocabularyWord", b =>
                {
                    ...
                    b.HasIndex("UserId", "SiteId", "NextReviewAt")
                        .HasDatabaseName("ix_vocabulary_words_user_id_site_id_next_review_at");
            ...
            modelBuilder.Entity("Domain.Entities.BoardTask", b =>
                {
                    b.HasOne("Domain.Entities.Site", "Site")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_board_tasks_sites_site_id");
            ...
            modelBuilder.Entity("Domain.Entities.CodeGenJob", b =>
                {
                    b.HasOne("Domain.Entities.Site", "Site")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_code_gen_jobs_sites_site_id");
            ...
            modelBuilder.Entity("Domain.Entities.ReadingRoom", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Site", "Site")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_reading_rooms_sites_site_id");
            ...
            modelBuilder.Entity("Domain.Entities.ReadingRoomInvite", b =>
                {
                    b.HasOne("Domain.Entities.User", "CreatedByUser")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reading_room_invites_users_created_by_user_id");

                    b.HasOne("Domain.Entities.ReadingRoom", "Room")
                        .WithMany("Invites")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reading_room_invites_reading_rooms_room_id");
            ...
            modelBuilder.Entity("Domain.Entities.ReadingRoomMember", b =>
                {
                    b.HasOne("Domain.Entities.Chapter", "CurrentChapter")
                        .WithMany()
                        .HasForeignKey("CurrentChapterId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_reading_room_members_chapters_current_chapter_id");
                    ...
                    b.HasOne("Domain.Entities.ReadingRoom", "Room")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reading_room_members_reading_rooms_room_id");
                    ...
                    b.HasOne("Domain.Entities.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reading_room_members_users_user_id");
