      ...
      <div className="reader-settings-drawer" ref={containerRef} role="dialog" aria-modal="true" aria-label="Reading Settings">
        ...
        <div className="reader-settings-drawer__section">
          ...
          <div className="reader-settings-drawer__toggle-row">
            ...
            <button
              className={`reader-settings-drawer__toggle ${settings.showReaderStats ? 'active' : ''}`}
              onClick={() => onUpdate({ showReaderStats: !settings.showReaderStats })}
              role="switch"
              aria-checked={settings.showReaderStats}
            >
              <span className="reader-settings-drawer__toggle-thumb" />
            </button>
          </div>
