      ...
      <div className="stats-chart-container" style={{ height: 280 }}>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ left: 0, right: 20, top: 10, bottom: 0 }}>
            ...
            <Tooltip />
            <Legend />
            <Line yAxisId="books" type="monotone" dataKey="books" name={t('stats.books')} stroke="#4169E1" strokeWidth={2} dot={{ r: 3 }} />
            <Line yAxisId="pages" type="monotone" dataKey="pages" name={t('stats.pages')} stroke="#E8766C" strokeWidth={2} dot={{ r: 3 }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
      )}
