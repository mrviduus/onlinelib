/**
 * TextStack brand mark (admin copy — kept in sync with apps/web/src/components/Logo.tsx).
 *
 * Shared monorepo package would be overkill for two files; we accept
 * the small duplication to avoid the build-graph complication.
 */
